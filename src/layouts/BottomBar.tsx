...
export function BottomBar({ activeDrones = 0 }: { activeDrones?: number }) {
  ...
  return (
    <footer className="w-full z-50 flex justify-between items-center px-5 py-2 bg-surface-dim border-t border-outline-variant h-12 shrink-0">
      {/* Left section */}
      <div className="flex gap-8 items-center">
        <div className="text-on-surface-variant flex items-center gap-3 text-label-caps text-[11px]">
          <span className="material-symbols-outlined text-[18px] text-primary">monitor_heart</span>
          <span className="text-on-surface-variant tracking-wide">System Health</span>
        </div>
